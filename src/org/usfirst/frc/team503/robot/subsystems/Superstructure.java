...
//import org.usfirst.frc.team503.robot.GoalTracker;
import org.usfirst.frc.team503.robot.RobotState;
import com.team503.lib.Loops.Loop;
import com.team503.lib.util.InterpolatingDouble;
import com.team503.lib.util.Rotation2d;

import com.team503.lib.util.TimeDelayedBoolean;
import edu.wpi.first.wpilibj.Timer;
import edu.wpi.first.wpilibj.networktables.NetworkTable;
import edu.wpi.first.wpilibj.smartdashboard.SmartDashboard;

import static org.usfirst.frc.team503.robot.subsystems.Superstructure.WantedIntakeState.WANT_TO_RUN_INTAKE;
...
//        return mHood.hasHomed() ? SystemState.DEPLOYED : SystemState.DEPLOYED_AND_HOMING_HOOD;
        return SystemState.DEPLOYED;  // added by 503 for testing 
...
//                mConsecutiveCyclesOnTarget++;
 ...
 //       return mConsecutiveCyclesOnTarget > Constants.kAutoAimMinConsecutiveCyclesOnTarget && is_stopped;
    return true; //added by 503 for testing -- not part of original code 
    }
